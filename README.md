...
--------------------------
    ...
    3) cssselector    [CSS path string - Also recommended as it was unique for each element, 
                       however a bit complex compare to XPATH]
...
------------------------
    ...
    Use <Alt> + <Enter> at Value column to add another XPATH
